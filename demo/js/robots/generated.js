...
// and ingest.js never learn that this robot arrived over the wire.
//
...
export async function loadGeneratedRobot(id) {
  ...
  return {
    id,
    // ingest.js names the device off this, not off the slug: the visitor's terminal has to read
    // like their robot, not like a mailing-list token.
