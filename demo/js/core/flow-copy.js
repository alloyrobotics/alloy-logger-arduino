...
function variant(missionIntro, failureIntro, firstQuestion, followUp) {
  return { missionIntro, failureIntro, firstQuestion, followUp };
}
...
export const flowCopy = {
  ...
  ssl: {
    base: variant(
      'Soccer, played by autonomous robots.',
